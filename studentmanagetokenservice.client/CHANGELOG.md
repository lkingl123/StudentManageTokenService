...
- Create Angular project with ng: `ng new studentmanagetokenservice.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`studentmanagetokenservice.client.esproj`).
